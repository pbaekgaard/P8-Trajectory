...
class TEDCompressed(object):
    def __init__(self, compressed_entry_paths: np.ndarray, compressed_time_flags: np.ndarray, compressed_time_seqs: np.ndarray, compressed_distance_seqs: np.ndarray):
        super().__init__()
