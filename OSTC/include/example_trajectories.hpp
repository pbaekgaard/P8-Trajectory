#ifndef __EXAMPLE_TRAJECTORIES_HPP__
#define __EXAMPLE_TRAJECTORIES_HPP__

#include <trajectory.hpp>
static Trajectory t(0, std::vector<SamplePoint>{
...
static Trajectory t_copy(10, t.points);

static Trajectory t1(1,
...
static Trajectory t2(2, std::vector<SamplePoint>{SamplePoint(5, 16, 2), SamplePoint(7.5, 16, 3), SamplePoint(8.5, 16, 4),
...
static Trajectory t3(3, std::vector<SamplePoint>{SamplePoint(5.5, 14, 13), SamplePoint(7, 14, 14), SamplePoint(8, 14.5, 15),
...
static Trajectory t5(5, std::vector<SamplePoint>{SamplePoint(20.5, 13, 7), SamplePoint(19, 13, 8), SamplePoint(17.5, 13, 9),
...
static Trajectory t7(7, std::vector<SamplePoint>{SamplePoint(15.5, 6.5, 9), SamplePoint(15.5, 6, 10), SamplePoint(15.5, 5, 11),
