...
void run_example()
{
    Trajectory t(0, std::vector<SamplePoint>{
                        SamplePoint(3, 15.4, "ts"),   SamplePoint(5, 15.4, "ts"),   SamplePoint(7, 15.5, "ts"),
                        SamplePoint(8.5, 15.5, "ts"), SamplePoint(9.5, 15.5, "ts"), SamplePoint(10, 15.5, "ts"),
                        SamplePoint(10, 15.5, "ts"),  SamplePoint(12, 14, "ts"),    SamplePoint(12, 12, "ts"),
    ...
    Trajectory t4(
        4, std::vector<SamplePoint>{SamplePoint(5.5, 11, "ts"), SamplePoint(6.5, 11, "ts"), SamplePoint(7.5, 11, "ts"),
                                    SamplePoint(8.5, 11, "ts"), SamplePoint(9.5, 11, "ts"), SamplePoint(11.5, 11, "ts"),
                                    SamplePoint(11.5, 10, "ts"), SamplePoint(11.5, 8.5, "ts"),
                                    ...
                                    SamplePoint(13.5, 2, "ts"), SamplePoint(13.5, 1, "ts"), SamplePoint(12.5, 1, "ts"),
                                    SamplePoint(10.5, 1, "ts"), SamplePoint(8.5, 1, "ts")});
