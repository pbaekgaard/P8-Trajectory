...
TEST(Trajectories, trajectories_are_equal)
{
    ...
    auto traj3 = Trajectory(3, std::vector<SamplePoint>{SamplePoint(1, 2, 0)});
...
{
    auto parent = Trajectory{1, std::vector<SamplePoint>{SamplePoint(1, 2, 0), SamplePoint(2, 3, 0),
                                                         SamplePoint(4, 7, 0), SamplePoint(11, 12, 0)}};
    auto subtrajectory = parent(2, 3);
    auto expected_subtrajectory =
        Trajectory{1, std::vector<SamplePoint>{SamplePoint(4, 7, 0), SamplePoint(11, 12, 0)}, 2, 3};
    EXPECT_EQ(subtrajectory, expected_subtrajectory);
}

TEST(Trajectories, mrtset_is_correct_format) {
    GTEST_SKIP() << "Skip until MRT works" << std::endl;
    auto T1 =
        Trajectory(1, std::vector<SamplePoint>{SamplePoint(2.0, 2.5, 0), SamplePoint(1.5, 3.0, 0), SamplePoint(1.5, 4.0, 0),
    ...
    auto T4 = Trajectory(
        4, std::vector<SamplePoint>{
               SamplePoint(5.5, 14.0, 0), SamplePoint(6.5, 14.0, 0),  SamplePoint(7.5, 14.5, 0),  SamplePoint(8.5, 14.5, 0),
               SamplePoint(9.5, 14.0, 0), SamplePoint(11.5, 12.0, 0), SamplePoint(11.5, 10.0, 0), SamplePoint(11.5, 8.5, 0),
               SamplePoint(11.5, 8.0, 0), SamplePoint(11.5, 6.0, 0),  SamplePoint(11.5, 5.0, 0),  SamplePoint(12.5, 4.0, 0),
               SamplePoint(13.0, 3.5, 0), SamplePoint(13.5, 3.0, 0),  SamplePoint(13.5, 2.0, 0),  SamplePoint(13.5, 1.0, 0),
               SamplePoint(12.5, 1.0, 0), SamplePoint(10.5, 1.0, 0),  SamplePoint(8.5, 1.0, 0),
    ...
    auto T6 =
        Trajectory(6, std::vector<SamplePoint>{SamplePoint(2.0, 6.0, 0), SamplePoint(2.0, 4.5, 0), SamplePoint(2.0, 3.5, 0),
    ...
    auto T7 =
        Trajectory(7, std::vector<SamplePoint>{SamplePoint(15.5, 6.5, 0), SamplePoint(15.5, 6.0, 0), SamplePoint(15.5, 5.0, 0),
    ...
    auto T = Trajectory(
        0, std::vector<SamplePoint>{
               SamplePoint(3.0, 15.5, 0),  SamplePoint(5.0, 15.5, 0),  SamplePoint(7.0, 15.5, 0),  SamplePoint(8.5, 15.5, 0),
               SamplePoint(9.5, 15.5, 0),  SamplePoint(10.0, 15.5, 0), SamplePoint(11.5, 15.5, 0), SamplePoint(12.0, 14.0, 0),
               SamplePoint(12.0, 12.0, 0), SamplePoint(12.0, 11.0, 0), SamplePoint(12.0, 10.0, 0), SamplePoint(12.0, 8.0, 0),
